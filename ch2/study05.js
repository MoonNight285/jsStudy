...
console.log(`toString()으로 변환 : ${(100 + 200).toString()}`);
...
// toFixed() : 소수점 자리를 지정한 크기만큼 표현, 반올림 효과 적용, 값이 없는경우 0으로 소수점 채운다.
...
// NaN : Not a Number 의 줄임말로 숫자가 아니라는 뜻이다.
// isNaN() : 지정한 데이터가 숫자인지 아닌지를 판단하는 명령어, 숫자가 아니면 true, 숫자이면 false
// 사용법 : 변수 = isNaN(데이터);
console.log("\n ----- isNaN() ----- \n");
const num3 = "1234";
const num4 = "12삼사";
...
// Number() : 문자열 데이터 타입의 숫자를 숫자형 데이터 타입으로 변환, 변환이 불가능할 경우 NaN 이라는 데이터 타입을 반환
// 사용법 : 변수 = Number(데이터);
console.log("\n ----- Number() ----- \n");
...
// parseInt() : 문자열 데이터 타입의 숫자를 정수로 데이터 변환, 변환이 불가능할 경우 NaN 이라는 데이터 타입을 반환
// 사용법 : 변수 = parseInt(데이터);
console.log("\n ----- parseInt() ----- \n");
...
// parseFloat() : 문자열 데이터 타입의 숫자를 실수 데이터로 변환, 변환이 불가능할 경우 NaN 이라는 데이터 타입을 반환
